classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Virtual-Controls-Laboratory";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Virtual Controls Laboratory';
            ...
            app.ReviewTitle.Text = 'Welcome to Virtual Controls Laboratory';
